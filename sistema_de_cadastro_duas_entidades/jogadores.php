...
<nav>
  ...
  <li><a href="cadastrados.php" >Times</a></li>
  <li><a href="jogadores.php" >Addjogador</a></li>
</nav>
   ...
   <?php
            ...
            $times = file('tabela.csv');
            foreach($times as $seleção){
            $times[] = explode(',', $seleção);
            }
...
<section class="form">
 ...
 <td><?= $dado ?></td>
 <?php endforeach ?>
 <td><a id="apg" href="apagarj.php?id=<?= $j ?>">x</a></td>
 </tr>
